...
public class CartController : Controller
{
    ...
    public IActionResult OrderConfirmation(int ID)
    {
        ...
        var result = (from product in _unitOfWork.Item.GetAll()
                      join order in _unitOfWork.OrderDetail.GetAll().Where(x => x.OrderId == orderHeader.Id)
                        on product.Id equals order.ItemId
