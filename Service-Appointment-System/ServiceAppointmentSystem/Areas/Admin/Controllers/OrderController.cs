...
namespace ServiceAppointmentSystem.Areas.Admin.Controllers
{
	...
	public class OrderController : Controller
	{
		...
		{
			_unitOfWork.Order.UpdateStatus(orderViewModel.Order.Id, Constants.StatusProcessing);
			_unitOfWork.Save();
		...
		public IActionResult ShipOrder(OrderViewModel orderViewModel)
		{
			...
			var user = _unitOfWork.AppUser.GetFirstOrDefault(x => x.Id == orderHeader.UserId);
            ...
            _emailSender.SendEmailAsync(user.Email, "Item Shipped",
			$"Dear {user.FullName}, <br><br>Your order has been shipped as per your request. <br>The total amount is {orderViewModel.Order.OrderTotal}. <br><br>Regards.");
